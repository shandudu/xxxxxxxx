...
values (1860000000000000201, 'purchasing.menu', 'ErpPurchasing', '/erp/purchasing', 17, 'mdi:cart-outline', 1, '/plugins/purchasing/views/index', 'erp:purchasing:view', 1, 1, 1, '', null, @system_menu_id, now(), null);
insert into sys_menu (id, title, name, path, sort, icon, type, component, perms, status, display, cache, link, remark, parent_id, created_time, updated_time)
values
