...
insert into sys_menu (id,title,name,path,sort,icon,type,component,perms,status,display,cache,link,remark,parent_id,created_time,updated_time) values (1860000000000000301,'production.menu','MesProduction','/mes/production',18,'mdi:factory',1,'/plugins/production/views/index','mes:production:view',1,1,1,'',null,@system_menu_id,now(),null);
