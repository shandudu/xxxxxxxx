...
values (1860000000000000101, 'inventory.menu', 'MesInventory', '/mes/inventory', 16, 'mdi:clipboard-list-outline', 1, '/plugins/inventory/views/index', null, 1, 1, 1, '', null, (select id from sys_menu where name = 'System'), now(), null);
insert into sys_menu (id, title, name, path, sort, icon, type, component, perms, status, display, cache, link, remark, parent_id, created_time, updated_time)
values
