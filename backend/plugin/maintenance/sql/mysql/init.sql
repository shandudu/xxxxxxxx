...
values ('maintenance.menu', 'MesMaintenance', '/mes/maintenance', 19, 'mdi:tools', 1, '/plugins/maintenance/views/index', 'mes:maintenance:view', 1, 1, 1, '', null, @maintenance_parent_id, now(), null, 0, null);
set @maintenance_menu_id = last_insert_id();
insert into sys_menu (title, name, path, sort, icon, type, component, perms, status, display, cache, link, remark, parent_id, created_time, updated_time, deleted, deleted_time)
values
