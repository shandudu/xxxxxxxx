...
values ('trace.menu', 'MesTrace', '/mes/trace', 15, 'mdi:graph-outline', 1, '/plugins/trace/views/index', null, 1, 1, 1, '', null, @system_menu_id, now(), null);

set @trace_menu_id = LAST_INSERT_ID();
